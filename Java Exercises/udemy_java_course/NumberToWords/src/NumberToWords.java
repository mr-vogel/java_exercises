...
//* numberToWords(-12); should print "Invalid Value" since the parameter is negative.
    ...
    public static void numberToWords(int number){
        ...
        for(int i = 0; i<numberOfZeros; numberOfZeros--){
            System.out.println("Zero");
        }
    }
...
For example, if the number has a value of 100, the method getDigitCount should return 3 since the number 100 has 3 digits
(1, 0, 0).
